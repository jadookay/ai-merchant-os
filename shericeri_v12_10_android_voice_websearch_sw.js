const CACHE = 'shericeri-v12.10-android-voice-websearch-v1';
...
self.addEventListener('fetch', event => {
  ...
  // Network-first navigation prevents development deployments from being
  // trapped behind an old cached index.html. Cache is offline fallback only.
